      ...
      <div className="container flex h-16 md:h-20 items-center justify-between px-4 md:px-6">
        ...
        <Link href="/" className="flex items-center gap-2.5 md:gap-3">
          <div className="flex h-10 w-10 md:h-12 md:w-12 items-center justify-center rounded-full bg-primary shrink-0">
            <span className="text-xl md:text-2xl font-bold text-primary-foreground">恭</span>
          </div>
          <div className="flex flex-col">
            <span className="text-base md:text-xl font-bold leading-none text-foreground tracking-tight">
              Cung Hỷ Phát Tài
            </span>
            <span className="text-xs md:text-sm text-muted-foreground mt-0.5">Ẩm Thực Trung Hoa</span>
          </div>
        </Link>
