...
export default function AdminCategoriesPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!formData.name || !formData.nameEn || !formData.description || !formData.order) {
      toast({
        title: "Lỗi",
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Thêm, sửa, xóa danh mục món ăn và upload ảnh đại diện</p>
      </div>
